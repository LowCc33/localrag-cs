...
- **多模型协作**：Qwen2.5-7B-Q3_K_S（生成）+ Qwen3-Embedding（向量）+ Qwen3-Reranker（精排）
...
┌──────▼───────────────▼───────────────────────────────┐
│                  推理层 (llama.cpp)                    │
│  Qwen2.5-7B-Q3_K_S (生成)  │  Qwen3-Embedding (向量) │
│  Qwen3-Reranker (精排)                                │
└──────────────────────┬───────────────────────────────┘
                       │
┌──────────────────────▼───────────────────────────────┐
...
| **模型配置** | Qwen2.5-7B-Instruct-Q3_K_S（生成，~4GB） |
...
```bash
# 生成模型
wget -P ~/models/Qwen2.5-7B-Instruct-GGUF/ https://huggingface.co/Qwen/Qwen2.5-7B-Instruct-GGUF/resolve/main/Qwen2.5-7B-Instruct-Q3_K_S.gguf
